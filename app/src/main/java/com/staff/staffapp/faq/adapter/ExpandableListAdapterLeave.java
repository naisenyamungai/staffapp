...
public class ExpandableListAdapterLeave extends BaseExpandableListAdapter {
    private Context context;
    private List<String> listDataHeader;
    private HashMap<String, List<String>> listHashMap;

    public ExpandableListAdapterLeave(Context context, List<String> listDataHeader, HashMap<String, List<String>> listHashMap){
